...
./preprocess_mds_file.py \
    -d /groups/umcg-bios/tmp01/resources/genotypes-hrc-imputed-vcf/2023-06-28-mds-NoRNAPhenoNA-NoSexNA-NoMixups-SamplesVariantFilter-BonferroniHWE/allchr-mds.mds \
    -gte /groups/umcg-bios/tmp01/projects/PICALO/data/BIOS_GTE.txt.gz \
    -op BIOS-2023-06-28-mds-NoRNAPhenoNA-NoSexNA-NoMixups-SamplesVariantFilter-BonferroniHWE-
    
./preprocess_mds_file.py \
    -d /groups/umcg-bios/tmp01/resources/genotypes-hrc-imputed-vcf/2023-06-28-mds-NoRNAPhenoNA-NoSexNA-NoMixups-SamplesVariantFilter-BonferroniHWE-NoMDSOutlier/allchr-mds.mds \
    -gte /groups/umcg-bios/tmp01/projects/PICALO/data/BIOS_GTE.txt.gz \
    -op BIOS-2023-06-28-mds-NoRNAPhenoNA-NoSexNA-NoMixups-SamplesVariantFilter-BonferroniHWE-NoMDSOutlier
"""
