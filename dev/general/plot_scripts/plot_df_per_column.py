...
./plot_df_per_column.py \
    -d /groups/umcg-bios/tmp01/projects/PICALO/preprocess_scripts/preprocess_mds_file/BIOS-2023-06-28-mds-NoRNAPhenoNA-NoSexNA-NoMixups-SamplesVariantFilter-BonferroniHWE-allchr-mds.txt.gz \
    -std /groups/umcg-bios/tmp01/projects/PICALO/data/BIOS_STD.txt.gz \
    -o BIOS-allchr-mds-BIOS-NoRNAPhenoNA-NoSexNA-NoMixups-VariantSubsetFilter-BonferroniHWE \
    -e png pdf
...
./plot_df_per_column.py \
    ...
    -transpose \
    -o 2022-03-24-MetaBrain_CortexEUR_NoENA_NoRNAseqAlignmentMetrics_GT1AvgExprFilter_PrimaryeQTLs_UncenteredPCA_log2_covremoved_scalelocreturned_PCA \
    -e png pdf
...
./plot_df_per_column.py \
    ...
    -std /groups/umcg-biogen/tmp01/output/2020-11-10-PICALO/preprocess_scripts/prepare_picalo_files/2022-03-24-MetaBrain_CortexEUR_NoENA_NoRNAseqAlignmentMetrics_GT1AvgExprFilter_PrimaryeQTLs_UncenteredPCA/sample_to_dataset.txt.gz \
    -transpose \
    -o 2022-03-24-MetaBrain_CortexEUR_NoENA_NoRNAseqAlignmentMetrics_GT1AvgExprFilter_PrimaryeQTLs_UncenteredPCA_GeneSetEnrichmentExprMatrix_PCA \
    -e png pdf
...
./plot_df_per_column.py \
    ...
    -transpose \
    -o 2022-03-24-BIOS_NoRNAPhenoNA_NoSexNA_NoMixups_NoMDSOutlier_NoRNAseqAlignmentMetrics_WithUncenteredPCA_log2_covremoved_scalelocreturned_PCA \
    -e png pdf
...
./plot_df_per_column.py \
    ...
    -std /groups/umcg-bios/tmp01/projects/PICALO/preprocess_scripts/prepare_picalo_files/2022-03-24-BIOS_NoRNAPhenoNA_NoSexNA_NoMixups_NoMDSOutlier_NoRNAseqAlignmentMetrics_GT1AvgExprFilter_PrimaryeQTLs_UncenteredPCA/sample_to_dataset.txt.gz \
    -transpose \
    -o 2022-03-24-BIOS_NoRNAPhenoNA_NoSexNA_NoMixups_NoMDSOutlier_NoRNAseqAlignmentMetrics_WithUncenteredPCA_GeneSetEnrichmentExprMatrix_PCA \
    -e png pdf  
