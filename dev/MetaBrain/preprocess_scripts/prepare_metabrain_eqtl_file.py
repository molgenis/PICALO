...
class main():
    def __init__(self):
        ...
        # Set variables.
        self.outdir = os.path.join(str(Path(__file__).parent.parent), 'prepare_metabrain_eqtl_file')
