...
class main():
    ...
    def start(self):
        ...
        for idx in range(5):
            ...
            comp_eur_path = "/groups/umcg-biogen/tmp01/output/2020-11-10-DeconOptimizer/output_CortexEUR_woENA_woGVEX_PCs/{}/results_{}_df.txt.gz".format(component, eur_iter_df[component])
            ...
            comp_afr_path = "/groups/umcg-biogen/tmp01/output/2020-11-10-DeconOptimizer/MetaBrain_CortexAFR_woENA_PICReplication/{}/results_{}_df.txt.gz".format(component, afr_iter_fdr[component])
